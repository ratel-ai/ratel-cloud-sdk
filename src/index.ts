...
/**
 * Management & intelligence client for Ratel Cloud: catalog writes, intent
 * analysis, and suggestion review over the v1 HTTP API. Pure fetch — no native
 * addon, no BM25; all intelligence stays server-side.
 *
